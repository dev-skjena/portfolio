...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "skjena7350@gmail",
    href: "mailto:skjena7350@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/santosh-kumar-jena/",
    content: "/santosh-kumar-jena",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/dev-skjena",
    content: "/dev-skjena",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Santosh Kumar Jena</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Santosh, a Fullstack developer passionate about
